...
const FISH_TYPES = [
  ...
  // ===== World 9: Sông Băng Bắc Cực — cá xứ lạnh =====
  { id: 'tuyet',    name: 'Cá tuyết',        bodyCol: '#d0e8f0', bellyCol: '#ffffff', backCol: '#7090a8', finCol: '#a0c0d0', size: 30, speed: 1.4, rarity: 20,  value: 600,    strength: 1.5, minD: 0.3, maxD: 0.95, rare: false, likes: ['shrimp', 'lure'],       shape: 'herring',   tireMax: 2, wMin: 3.0,   wMax: 25.0,  lMin: 50,  lMax: 120 },
  { id: 'hoiBac',   name: 'Cá hồi Bắc Cực',  bodyCol: '#f08070', bellyCol: '#ffd0c0', backCol: '#a04030', finCol: '#c05040', size: 34, speed: 2.2, rarity: 12,  value: 1500,   strength: 2.2, minD: 0.3, maxD: 1.0,  rare: false, likes: ['shrimp', 'lure', 'frog'], shape: 'bluefish',  tireMax: 3, wMin: 5.0,   wMax: 40.0,  lMin: 60,  lMax: 140 },
  { id: 'kiemBang', name: 'Cá kiếm băng',    bodyCol: '#a0d0e8', bellyCol: '#e0f4ff', backCol: '#4070a0', finCol: '#80b0d0', size: 50, speed: 3.4, rarity: 4,   value: 9000,   strength: 5.0, minD: 0.4, maxD: 1.0,  rare: true,  likes: ['lure', 'heavy', 'electric'], shape: 'swordfish', tireMax: 6, wMin: 100.0, wMax: 500.0, lMin: 250, lMax: 500 },
